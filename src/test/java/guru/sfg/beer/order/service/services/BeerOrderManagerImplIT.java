...
public class BeerOrderManagerImplIT {
    ...
    void testFailedAllocation() throws JsonProcessingException {
        ...
        AllocationFailureEvent allocationFailureEvent = (AllocationFailureEvent) jmsTemplate.receiveAndConvert(JmsConfig.ALLOCATE_FAILED_ORDER_QUEUE);
    ...
    void testNewToPickedUp() throws JsonProcessingException {
        ...
        BeerOrder pickedUpOrder = beerOrderRepository.findById(savedBeerOrder.getId()).orElseThrow();
